...
const mockPosts = [
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1618064541372-289bdb6f5b7b?q=80&w=2533&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
    url: '/blog/flights-cheap-guide-complete-flights-'
  },
  {
    id: '1779713968121',
    ...
    <div className="min-h-screen bg-[#fdfbf3]">
      ...
      <section className="bg-gradient-to-r from-blue-600 to-blue-800 text-white py-24">
        <div className="container mx-auto px-6 lg:px-8 text-center">
          <h1 className="text-4xl md:text-6xl font-bold mb-6 text-white hebrew-text">
            טיסות זולות - המדריך המלא
          </h1>
          <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto text-white hebrew-text">
            גלה את הסודות למציאת טיסות זולות בישראל ובעולם. טיפים, טריקים ומדריכים מקצועיים לחיסכון על טיסות.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link 
              href="/blog" 
              className="bg-white text-blue-600 px-8 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-colors duration-200 hebrew-text"
            >
              קרא מאמרים
            </Link>
            <Link 
              href="#latest-posts" 
              className="border-2 border-white text-white px-8 py-3 rounded-lg font-semibold hover:bg-white hover:text-blue-600 transition-colors duration-200 hebrew-text"
            >
              מאמרים אחרונים
            </Link>
          </div>
      ...
      <section id="latest-posts" className="py-20">
        <div className="container mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4 hebrew-text">
              מאמרים אחרונים
            </h2>
          ...
          <div className="text-center mt-16">
            ...
            >
              <span className="hebrew-text">צפה בכל המאמרים</span>
